		...
		<div className="lg:min-h-screen relative mb-60">
			<Slider {...settings}>
				<div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
					...
					<div
						className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
						<p className="text-xl uppercase">Get the Best products for you</p>
						<p className="w-96 text-center text-zinc-600">Browse the latest phones in the Market and get the
							one you dream for</p>
						<p className="text-2xl font-semibold">Phones in Demand</p>
						<button className="text-base font-medium text-white bg-designColor rounded-md px-4 py-2">Select
							a product
						</button>
					</div>
				</div>
